...
import SelcatedVendor from "./selactedvendor";
import { SubmitImage } from "../../assets/images";
...
export default function CAPEXPopup({ onClose, onOpenCatalog, onCloseCatalog }) {
    ...
    const validationSchema = Yup.object({
        ...
        item: Yup.string().required("Equipment/item is required"),
        reason: Yup.string().required("Reason is required"),
        urgency: Yup.string().required("Urgency is required"),
        impact: Yup.string().required("Operations description is required"),
    });
                            ...
                            <div className="overflow-y-auto h-[40vh] md:h-[76vh] px-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5 mb-4 md:mb-8">
                                    ...
                                    <div
                                        ...
                                        className={`cursor-pointer rounded-lg px-3 py-2 border transition duration-300
                                                     ${selectedVendor === "dl"
                                                ? "bg-[rgba(8,123,179,0.05)] text-[#087BB3] border-[#087BB3]"
                                                : "bg-[#F7F7F7] border-transparent"
                                            }`}
                                    >
                                        <p className="font-medium text-sm mb-2.5">DL Preferred Vendor</p>
                                        <p className="text-[#203430] text-xs">
                                    ...
                                    >
                                        <p className="font-medium text-sm mb-2.5">Use my own vendor</p>
                                        <p className="text-[#203430] text-xs">
                    ...
                    <div className="bg-white rounded-2xl shadow-lg max-w-150 w-full text-center" >
                        <div className="p-4 md:p-8">
                            <div className="flex justify-between items-center mb-2 md:mb-8">
                                ...
                                <div>
                                    <img src={SubmitImage} alt="sumbint-tick" width={100} height={100} loading="lazy" />
                                </div>
                            </div>
