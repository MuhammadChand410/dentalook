                        ...
                        {Array.from({ length: 4 }, (_, index) => {
                            ...
                            return (
                                <tr key={index} className="border border-[#F2F2F2] hover:bg-gray-50">
                                    ...
                                    <td className="px-4 py-2 border border-[#F2F2F2] text-xs">{item?.subheading || ''}</td>
                                    <td className="px-4 py-2 border border-[#F2F2F2] text-xs">{item?.hedding || ''}</td>
                                    <td className="px-4 py-2 ">
                                    ...
                                    <td className="px-4 py-2 border border-[#F2F2F2] text-xs font-medium">{item?.price || ''}</td>
                                </tr>
                            );
                        })}
                    </tbody>
