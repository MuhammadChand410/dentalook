...
export default function TicketDetails() {
    ...
    return (
        <div className="">
            <div className="py-4.5 flex items-start md:items-center gap-1 justify-between border-b border-[#E2E8F0]">
            ...
            {POPUP_BUTTON.map(card =>
                <div className="py-4.5 flex items-start md:items-center gap-2 md:gap-1 justify-between border-b border-[#E2E8F0]" key={card.id}>
            ...
            <div>
                <div className="flex items-start md:items-center gap-2 md:gap-4 border-b border-[#E2E8F0] mb-4">
                    <button
