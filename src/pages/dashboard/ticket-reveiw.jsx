import { ArtBoardFourIcon, ArtBoardIcon, ArtBoardThreeIcon, ArtBoardTwoIcon, VectorIcon } from "../../assets/icon";
    ...
    return (
        <div className="py-8">
            <div className="mb-8">
                ...
                <div className="grid md:grid-cols-5 grid-cols-2 items-start md:items-center justify-between">
                    <VectorIcon />
                    <ArtBoardIcon />
                    <ArtBoardTwoIcon />
                    <ArtBoardThreeIcon />
